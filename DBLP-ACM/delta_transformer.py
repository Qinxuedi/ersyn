...
vocab_path='models/authors/delta_{}_transformer_vocab.txt'.format(DELTA_ID)
...
N_EPOCHS = 400
CLIP = 1
log_path='models/authors/delta_{}_transformer_log.txt'.format(DELTA_ID)
...
for epoch in range(N_EPOCHS):
    ...
    torch.save(transformer_model.state_dict(), 'models/authors/delta_{}_transformer_model_{}.pt'.format(DELTA_ID,epoch))
